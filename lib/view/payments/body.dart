...
class _BodyState extends State<Body> {
  ...
  Future<void> _displayBottomSheet(BuildContext context) {
    return showModalBottomSheet(
      ...
      builder: (context) => BottomSheetContent(subscriptionCount: subscriptionCount),
    );
  }
}
...
class BottomSheetContent extends StatelessWidget {
  ...
  const BottomSheetContent({Key? key, required this.subscriptionCount}) : super(key: key);
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              _confirmSave(context, subscriptionCount);
            },
            style: ElevatedButton.styleFrom(
...
Future<void> _confirmSave(BuildContext context, int subscriptionCount) async {
  showDialog<void>(
    context: context,
      ...
      return AlertDialog(
        ...
        actions: <Widget>[
          ...
          TextButton(
            ...
            onPressed: () {
              Navigator.of(context).pop();
              _pushShowModalSPayNow(context, subscriptionCount);
...
void _pushShowModalSPayNow(BuildContext context, subscriptionCount) {
  PaymentDetailsModal.show(context,  subscriptionCount);
}
