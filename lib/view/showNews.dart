...
class _ShowNewsState extends State<ShowNews> {
            ...
            ElevatedButton(
              ...
              onPressed: () {
                ...
                Navigator.of(context).pushReplacement(
                  MaterialPageRoute(
                    builder: (context) =>
                        YourPost(), // Replace MenuHome with the actual widget for your home page
                  ),
                );
              },
            )
  ...
  Future<void> addBerita() async {
    await SQLHelper.addBerita(controllerJudul.text, controllerKategori.text,
        controllerDeskripsi.text);
  }

  Future<void> editBerita(int id) async {
    await SQLHelper.editBerita(id, controllerJudul.text,
        controllerKategori.text, controllerDeskripsi.text);
  }
}
